...
// Re-export shared utilities from kernel (used by cmd_ingest in main.rs)
pub use corvia_kernel::ingest::infer_content_role;
pub use corvia_kernel::ingest::infer_source_origin;
...
mod tests {
    use super::*;
    use corvia_kernel::ingest::blocked_path_match;
